<template>
  <footer class="relative">
    ...
    <!-- Bg -->
    <div class="absolute inset-0 bg-blue-600 -z-10" aria-hidden="true"></div>
    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6">
      ...
      <!-- Blocks -->
      <div class="grid sm:grid-cols-12 lg:grid-cols-10 gap-8 py-8 border-t border-blue-500">
        ...
        <div class="sm:col-span-12 lg:col-span-2 lg:max-w-xs">
          ...
          <router-link class="block group" to="/" aria-label="Cruip">
            <svg width="30" height="30" xmlns="http://www.w3.org/2000/svg">
              <path class="fill-blue-100 group-hover:fill-white transform duration-150 ease-in-out" d="M12 6v24C5.373 30 0 24.627 0 18S5.373 6 12 6Z" />
      ...
      <div class="md:flex md:items-center md:justify-between pb-4 md:pb-8">
        ...
        <ul class="flex mb-4 md:order-1 md:ml-4 md:mb-0">
          ...
          <li class="ml-2">
            <a class="flex justify-center items-center text-blue-300 hover:text-white transition duration-150 ease-in-out" href="#0" aria-label="Github">
              <svg class="w-8 h-8 fill-current" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="text-sm text-blue-300">
          © shagbai.com. 2023. All rights reserved.
        </div>
