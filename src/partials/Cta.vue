    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6">
      <div class="py-12 md:py-20">
        ...
        <div class="max-w-3xl mx-auto text-center">
          <h2 class="h2 font-cabinet-grotesk text-white mb-6" data-aos="fade-up">Take Action Now! </h2> <h3  class="h3 font-cabinet-grotesk text-white mb-6" data-aos="fade-up"> Donate to the Appeal Fund
and Be the Change You Want to See.</h3>
